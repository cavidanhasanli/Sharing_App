"""
Django settings for Sharing_Settings project.
...
SECRET_KEY = 'q!cmc*0#66(us6@+1!263cl!qq#qapx#7v2(*0b)g#+dxdf!29'
...
INSTALLED_APPS = [
    ...
    'login_register_app.apps.LoginRegisterAppConfig',
...
ROOT_URLCONF = 'Sharing_Settings.urls'
